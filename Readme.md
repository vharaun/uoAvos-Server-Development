...
- uoAvos will always be a work-in-progress project. That means that as long as we are alive and kicking, we will continue to find ways to improve the game engine to allow users to create game servers that could potentially compete with any pixel-art-oriented isometric game on the market! I have been playing MMORPGs for a little over two (2) decades now and I have a playbook of expansion ideas (lol).

<img src="http://www.uoavocation.net/portal/site_image/github/checkmark.png" width="24" height="24">**Some Food For Thought Regarding Your Releases**
- Since our Client and Server are open-source and the proprietors of Ultima Online™ do not own them: you could replace all of the graphics, redo all the data file extensions, and modify the client to read the new extensions as they did the old. Then you could upload your game to Steam as an indie release. 
