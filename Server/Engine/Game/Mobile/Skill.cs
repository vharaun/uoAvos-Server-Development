	...
	public class Skill
	{
		...
		public double Value
		{
			get
			{
				...
				var raceBonus = m_Owner.Owner.RacialSkillBonus;
		...
		public double NonRacialValue
		{
			get
			{
				...
				var statsOffset = ((m_UseStatMods ? m_Owner.Owner.Str : m_Owner.Owner.RawStr) * m_Info.StrScale) + ((m_UseStatMods ? m_Owner.Owner.Dex : m_Owner.Owner.RawDex) * m_Info.DexScale) + ((m_UseStatMods ? m_Owner.Owner.Int : m_Owner.Owner.RawInt) * m_Info.IntScale);
