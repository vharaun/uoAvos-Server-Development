...
namespace Server
{
	...
	public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
	{
		...
		public virtual void Serialize(GenericWriter writer)
		{
			...
			if (x != 0 || y != 0 || z != 0)
			{
				if (x >= Int16.MinValue && x <= Int16.MaxValue && y >= Int16.MinValue && y <= Int16.MaxValue && z >= SByte.MinValue && z <= SByte.MaxValue)
				{
					if (x != 0 || y != 0)
					{
		...
		{
			return GetBitmap(ItemID);
		}

		public void Measure(out int xMin, out int yMin, out int xMax, out int yMax)
		{
			Measure(GetBitmap(), out xMin, out yMin, out xMax, out yMax);
		}
		...
		public static System.Drawing.Rectangle MeasureBound(System.Drawing.Bitmap bmp)
		{
		...
		public static System.Drawing.Size MeasureSize(System.Drawing.Bitmap bmp)
		{
			Measure(bmp, out var xMin, out var yMin, out var xMax, out var yMax);

			return new System.Drawing.Size(xMax - xMin, yMax - yMin);
		}
