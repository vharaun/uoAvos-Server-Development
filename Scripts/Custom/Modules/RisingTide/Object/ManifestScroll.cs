...
{
	public class ManifestScroll : Item//0x2258 or 0x1F23 or 0x0FF4
	{
		public ManifestScroll()
		{
		}
	}
}

public class ManifestGump : Gump
{
	private readonly ManifestScroll m_Deed;
	private readonly Mobile m_From;

	public ManifestGump(Mobile from, ManifestScroll deed) : base(25, 25)
	{
		m_From = from;
		m_Deed = deed;
		...
		AddBackground(50, 10, 455, 236 + (10 * 24), 1579);

		AddImageTiled(58, 20, 438, 217 + (10 * 24), 2624);
		AddAlphaRegion(58, 20, 438, 217 + (10 * 24));

		AddImage(45, 5, 10460);
		AddImage(480, 5, 10460);
		AddImage(45, 221 + (10 * 24), 10460);
		AddImage(480, 221 + (10 * 24), 10460);
		...
		//AddButton(125, 168 + (10 * 24), 4005, 4007, 2, GumpButtonType.Reply, 0);
		//AddHtmlLocalized(160, 168 + (10 * 24), 300, 20, 1045155, 0x7FFF, false, false); // Combine this deed with another deed.

		AddButton(125, 192 + (10 * 24), 4005, 4007, 1, GumpButtonType.Reply, 0);
		AddHtmlLocalized(160, 192 + (10 * 24), 120, 20, 1011441, 0x7FFF, false, false); // EXIT
	}
