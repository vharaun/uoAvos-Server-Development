...
namespace Server.Engines.PartySystem
{
	public class Party : IParty
	{
		...
		private class RejoinTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				var message = Packet.Acquire(new MessageLocalizedAffix(Serial.MinusOne, -1, MessageType.Label, 0x3B2, 3, 1008087, "", AffixType.Prepend | AffixType.System, m_Mobile.Name, ""));
		...
		{
			var ourFaction = Faction.Find(m_Leader);
	...
	public class PartyMemberInfo
	{
		...
		public bool CanLoot { get => m_CanLoot; set => m_CanLoot = value; }
	...
	#region PartyChat Server Packets
