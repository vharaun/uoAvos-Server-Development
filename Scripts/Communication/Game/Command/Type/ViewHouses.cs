	...
	public class ViewHousesGump : Gump
	{
		...
		public ViewHousesGump(Mobile from, List<BaseHouse> list, BaseHouse sel) : base(50, 40)
		{
			...
			else
			{
				...
				var valid = Sextant.Format(sel.Location, map, ref xLong, ref yLat, ref xMins, ref yMins, ref xEast, ref ySouth);
		...
		public object FindHouseName(BaseHouse house)
		{
			...
			Items.HousePlacementEntry[] entries;

			entries = Items.HousePlacementEntry.ClassicHouses;
			...
			entries = Items.HousePlacementEntry.TwoStoryFoundations;
			...
			entries = Items.HousePlacementEntry.ThreeStoryFoundations;
