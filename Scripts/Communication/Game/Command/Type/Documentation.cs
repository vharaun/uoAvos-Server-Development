...
namespace Server.Commands
{
	public class Docs
	{
		...
		#region Bodies
		public static SortedSet<BodyEntry> LoadBodies()
		{
			var list = new SortedSet<BodyEntry>(BodyEntrySorter.Instance);

			var path = Core.FindDataFile("models.txt");
			...
			if (File.Exists(path))
			{
				foreach (var line in File.ReadLines(path))
				{
					...
					if (split.Length >= 9)
					{
						var body = (Body)Utility.ToInt32(split[0]);
						var type = (BodyType)(Utility.ToInt32(split[1]) + 1);

						if (type != BodyType.Empty)
						{
							list.Add(new BodyEntry(body, type, split[8]));
						}
					}
				}
			}
			else
			{
				foreach (var body in Body.Bodies)
				{
					if (!body.IsEmpty)
					{
						list.Add(new BodyEntry(body, body.Type, $"0x{body.BodyID:X4}"));
					}
				}
			}
				...
				if (list.Count > 0)
				{
					...
					foreach (var entry in list)
					{
						...
						if (type != lastType)
						{
							...
							switch (type)
							{
								case BodyType.Monster: html.WriteLine("      <b>Monsters</b> | <a href=\"#Sea\">Sea</a> | <a href=\"#Animals\">Animals</a> | <a href=\"#Human\">Human</a> | <a href=\"#Equipment\">Equipment</a><br><br>"); break;
								case BodyType.Sea: html.WriteLine("      <a href=\"#Top\">Monsters</a> | <b>Sea</b> | <a href=\"#Animals\">Animals</a> | <a href=\"#Human\">Human</a> | <a href=\"#Equipment\">Equipment</a><br><br>"); break;
								case BodyType.Animal: html.WriteLine("      <a href=\"#Top\">Monsters</a> | <a href=\"#Sea\">Sea</a> | <b>Animals</b> | <a href=\"#Human\">Human</a> | <a href=\"#Equipment\">Equipment</a><br><br>"); break;
								case BodyType.Human: html.WriteLine("      <a href=\"#Top\">Monsters</a> | <a href=\"#Sea\">Sea</a> | <a href=\"#Animals\">Animals</a> | <b>Human</b> | <a href=\"#Equipment\">Equipment</a><br><br>"); break;
								case BodyType.Equipment: html.WriteLine("      <a href=\"#Top\">Monsters</a> | <a href=\"#Sea\">Sea</a> | <a href=\"#Animals\">Animals</a> | <a href=\"#Human\">Human</a> | <b>Equipment</b><br><br>"); break;
							}
		...
		private static void SaveType(TypeInfo info, StreamWriter nsHtml, string nsFileName, string nsName)
		{
			...
			using (var typeHtml = Docs.GetWriter(info.FileName))
			{
		...
		private static void WriteType(TypeInfo info, StreamWriter typeHtml)
		{
			...
			var membs = type.GetMembers(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance | BindingFlags.DeclaredOnly);
		...
		public static void FormatGeneric(Type type, ref string typeName, ref string fileName, ref string linkName)
		{
			...
			if (type.IsGenericType)
			{
				...
				if (index > 0)
				{
					...
					var fnamBuilder = new StringBuilder("docs/types/" + Docs.SanitizeType(rootType));
					...
					for (var i = 0; i < typeArguments.Length; i++)
					{
						...
						var sanitizedName = Docs.SanitizeType(typeArguments[i].Name);
						var aliasedName = Docs.AliasForName(sanitizedName);
	...
	public class BodyEntry
	{
		...
		private readonly BodyType m_BodyType;
		private readonly string m_Name;
		...
		public BodyEntry(Body body, BodyType bodyType, string name)
		{
			m_Body = body;
			m_BodyType = bodyType;
			m_Name = name;
	...
	{
		public static readonly BodyEntrySorter Instance = new();

		private BodyEntrySorter()
		{ }
