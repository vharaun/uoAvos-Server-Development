...
namespace Server.Engines.Chat
{
	...
	internal class ChatInitializer
	{
		public static void Initialize()
		{
		...
		private static void DisplayChatTo(Mobile player)
		{
			...
			var account = player.Account as Account;
			var accountChatName = account.GetTag("ChatName");
		...
		private static void HideChatFrom(Mobile player)
		{
			...
			var user = ChatUser.GetChatUser(player);
		...
		private static void DefineChatName(Mobile player)
		{
			...
			var account = player.Account as Account;
			var accountChatName = (player.RawName).Replace(" ", "");
	...
	public class ChatUser
	{
		...
		public string Username
		{
			get
			{
				var acct = m_Mobile.Account as Account;
		...
		public static void RemoveChatUser(ChatUser user)
		{
			...
			for (var i = 0; i < user.m_Ignoring.Count; ++i)
			{
