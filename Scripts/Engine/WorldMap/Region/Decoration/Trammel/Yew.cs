...
namespace Server.Commands
{
	public static partial class Decorate
	{
		...
		{
			public static DecorationList[] Yew { get; } = Register(DecorationTarget.Trammel, "Yew", new DecorationList[]
			{
				#region Entries
				...
				new("Candelabra", typeof(CandelabraStand), 2601, "", new DecorationEntry[]
				{
					new(282, 989, 0, ""),
				}),
				...
				new("Mill Crate", typeof(FillableLargeCrate), 3645, "ContentType=Mill", new DecorationEntry[]
				{
					new(546, 810, 0, ""),
					new(546, 810, 3, ""),
					new(546, 811, 0, ""),
				...
				new("Inn Metal Chest", typeof(FillableMetalChest), 3708, "ContentType=Inn", new DecorationEntry[]
				{
					new(656, 826, 0, ""),
					new(656, 827, 0, ""),
				}),
