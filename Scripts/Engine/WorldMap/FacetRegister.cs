namespace Server.Misc
{
	public class MapDefinitions
	{
		public static void Configure()
		{
			...
			/// Example Of Registering A Clone Of One Of The Pre-Existing Custom Map/ Facets:
			/// - <copy and paste>: one of the 'map#.mul' and rename it to 'map32.mul'
