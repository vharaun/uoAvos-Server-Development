...
namespace Server.Misc
{
	public class CharacterCreation
	{
		...
		private static void FillBankAOS(Mobile m)
		{
			...
			PlaceItemIn(cont, 69, 66, new ShipModel());
			...
			if (Core.SE)    //This bag came only after SE.
			{
				...
				{
					var bow = cont.Items[i] as BaseRanged;
		...
		private static CityInfo GetStartLocation(CharacterCreatedEventArgs args, bool isYoung)
		{
			...
			var flags = args.State == null ? ClientFlags.None : args.State.Flags;
			var m = args.Mobile;
				...
				case 7: // Ninja
					{
						...
						var hues = new int[] { 0x1A8, 0xEC, 0x99, 0x90, 0xB5, 0x336, 0x89 };
				...
				case SkillName.Cooking:
					{
						...
						PackItem(new RawSaltwaterFishSteak());
