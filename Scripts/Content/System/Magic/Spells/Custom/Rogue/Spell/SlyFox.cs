...
{
	public class SlyFoxSpell : ClericTransformation
	{
		private static readonly Dictionary<Mobile, object[]> m_Table = new();

		public override Body Body => 225;

		public SlyFoxSpell(Mobile caster, Item scroll)
			: base(caster, scroll, RogueSpellName.SlyFox)
		{
		}
		...
		public override void DoEffect(Mobile m)
		{
			...
			if (!m_Table.ContainsKey(m))
			{
				var mods = new object[]
				{
					new StatMod(StatType.Dex, "SlyFoxDex", 20, TimeSpan.Zero),
