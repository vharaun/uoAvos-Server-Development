...
{
	public class FireBowSpell : RangerSpell
	{
		public override TimeSpan CastDelayBase => TimeSpan.FromSeconds(7.0);

		public FireBowSpell(Mobile caster, Item scroll)
			: base(caster, scroll, RangerSpellName.FireBow)
		{
		}
		...
		public override void OnCast()
		{
			if (CheckSequence())
			{
				...
				var weap = new TransientFireBow(Caster, duration);
