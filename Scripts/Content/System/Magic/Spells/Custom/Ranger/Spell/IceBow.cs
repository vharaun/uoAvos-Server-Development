...
{
	public class IceBowSpell : RangerSpell
	{
		public override TimeSpan CastDelayBase => TimeSpan.FromSeconds(7.0);

		public IceBowSpell(Mobile caster, Item scroll) 
			: base(caster, scroll, RangerSpellName.IceBow)
		{
		}
		...
		public override void OnCast()
		{
			if (CheckSequence())
			{
				...
				var weap = new TransientIceBow(Caster, duration);
