...
{
	public abstract class NecromancyTransformation : NecromancySpell, ITransformationSpell
	{
		...
		public NecromancyTransformation(Mobile caster, Item scroll, NecromancySpellName id)
			: base(caster, scroll, id)
		{
		}

		public NecromancyTransformation(Mobile caster, Item scroll, SpellInfo info) 
