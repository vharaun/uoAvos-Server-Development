...
{
	public class AnimateDeadSpell : NecromancySpell
	{
		public override TimeSpan CastDelayBase => TimeSpan.FromSeconds(1.5);

		public AnimateDeadSpell(Mobile caster, Item scroll) 
			: base(caster, scroll, NecromancySpellName.AnimateDead)
		{
		}
		...
		private static void SummonDelay(Mobile caster, Corpse corpse, Point3D loc, Map map, CreatureGroup group)
		{
			...
			var necromancy = caster.Skills[SkillName.Necromancy].Value;
			var spiritSpeak = caster.Skills[SkillName.SpiritSpeak].Value;
