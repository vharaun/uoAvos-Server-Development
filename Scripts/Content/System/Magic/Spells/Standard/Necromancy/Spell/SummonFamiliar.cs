...
{
	public class SummonFamiliarSpell : NecromancySpell
	{
		public override TimeSpan CastDelayBase => TimeSpan.FromSeconds(2.0);

		public SummonFamiliarSpell(Mobile caster, Item scroll) 
			: base(caster, scroll, NecromancySpellName.SummonFamiliar)
		{
		}
		...
		{
			var check = (BaseCreature)m_Table[Caster];
	...
	public class SummonFamiliarGump : Gump
	{
		...
		public SummonFamiliarGump(Mobile from, SummonFamiliarEntry[] entries, SummonFamiliarSpell spell) : base(200, 100)
		{
			...
			var necro = from.Skills[SkillName.Necromancy].Value;
			var spirit = from.Skills[SkillName.SpiritSpeak].Value;
		...
		public override void OnResponse(NetState sender, RelayInfo info)
		{
			...
			if (index >= 0 && index < m_Entries.Length)
			{
				...
				var necro = m_From.Skills[SkillName.Necromancy].Value;
				var spirit = m_From.Skills[SkillName.SpiritSpeak].Value;

				var check = (BaseCreature)SummonFamiliarSpell.Table[m_From];
