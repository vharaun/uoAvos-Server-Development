	...
	public class EvilOmenSpell : NecromancySpell
	{
		...
		public void Target(Mobile m)
		{
			...
			else if (CheckHSequence(m))
			{
				...
				var duration = TimeSpan.FromSeconds((Caster.Skills[SkillName.SpiritSpeak].Value / 12) + 1.0);
