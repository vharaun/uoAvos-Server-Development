	...
	public class CurseWeaponSpell : NecromancySpell
	{
		...
		public override void OnCast()
		{
			...
			else if (CheckSequence())
			{
				...
				var duration = TimeSpan.FromSeconds((Caster.Skills[SkillName.SpiritSpeak].Value / 3.4) + 1.0);
