...
{
	public class CleanseByFireSpell : ChivalrySpell
	{
		public override TimeSpan CastDelayBase => TimeSpan.FromSeconds(1.0);

		public CleanseByFireSpell(Mobile caster, Item scroll) 
			: base(caster, scroll, ChivalrySpellName.CleanseByFire)
		{
		}
		...
		public void Target(Mobile m)
		{
			...
			else if (CheckBSequence(m))
			{
				...
				if (p != null)
				{
					...
					var chanceToCure = 10000 + (int)(Caster.Skills[SkillName.Chivalry].Value * 75) - ((p.Level + 1) * 2000);
					chanceToCure /= 100;
				...
				var damage = 50 - ComputePowerValue(4);
