...
{
	public class BackstabAbility : NinjitsuAbility
	{
		public override SpellName ID => SpellName.Backstab;

		public override TextDefinition AbilityMessage => 1063089; // You prepare to Backstab your opponent.
