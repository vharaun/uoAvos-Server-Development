...
{
	public class KiAttackAbility : NinjitsuAbility
	{
		private static readonly Hashtable m_Table = new();

		public override SpellName ID => SpellName.KiAttack;

		public override TextDefinition AbilityMessage => 1063099; // Your Ki Attack must be complete within 2 seconds for the damage bonus!

		public KiAttackAbility()
		{
		}
