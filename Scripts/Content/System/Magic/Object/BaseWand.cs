...
namespace Server.Items
{
	...
	public abstract class BaseWand : BaseBashing, ITokunoDyable
	{
		...
		public virtual void ApplyDelayTo(Mobile from)
		{
			...
			Timer.DelayCall<Mobile>(GetUseDelay, ReleaseWandLock_Callback, from);
		}
		...
		public override void OnSingleClick(Mobile from)
		{
			...
			var eqInfo = new EquipmentInfo(number, Crafter, false, (EquipInfoAttribute[])attrs.ToArray(typeof(EquipInfoAttribute)));
