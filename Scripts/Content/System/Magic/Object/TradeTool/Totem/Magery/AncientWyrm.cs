...
{
	public class AncientWyrmTotem : Item
	{
		...
		[Constructable]
		public AncientWyrmTotem() : base(8406) // What Idol Do You Want To Affix To This Creature?
		{
			Movable = true;
		...
		{
			var sk = from.Skills[SkillName.Magery]; // Choose What Skill This Item Requires
			...
			else if (sk.Base >= m_Required)
			{
				...
				{
					from.BodyValue = 46; // Change Creature Type Here That You Wish Players To Transform Into
					from.PlaySound(362);
		...
		public AncientWyrmTotem(Serial serial) : base(serial)
		{
		}
