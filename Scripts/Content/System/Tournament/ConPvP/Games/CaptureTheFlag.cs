...
namespace Server.Engines.ConPVP
{
	...
	public sealed class CTFTeamInfo : IRankedCTF
	{
		...
		public CTFGame Game { get => m_Game; set => m_Game = value; }
	...
	public sealed class CTFController : EventController
	{
		...
		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team1 { get => m_TeamInfo[0]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team2 { get => m_TeamInfo[1]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team3 { get => m_TeamInfo[2]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team4 { get => m_TeamInfo[3]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team5 { get => m_TeamInfo[4]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team6 { get => m_TeamInfo[5]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team7 { get => m_TeamInfo[6]; set { } }

		[CommandProperty(AccessLevel.GameMaster)]
		public CTFTeamInfo Team8 { get => m_TeamInfo[7]; set { } }
	...
	public sealed class CTFGame : EventGame
	{
		...
		public override bool OnDeath(Mobile mob, Container corpse)
		{
			...
			var flags = corpse.FindItemsByType(typeof(CTFFlag), false);
				...
				if (teamInfo != null && teamInfo != victInfo)
				{
					...
					if (playerInfo != null)
					{
						...
						for (var i = 0; i < m_Controller.TeamInfo.Length; ++i)
						{
							...
							{
								for (var j = 0; j < ourFlagCarrier.Aggressors.Count; ++j)
								{
									var aggr = ourFlagCarrier.Aggressors[j];
		...
		private void Finish_Callback()
		{
			...
			for (var i = 0; i < m_Context.Participants.Count; ++i)
			{
				var teamInfo = m_Controller.TeamInfo[i % 8];
