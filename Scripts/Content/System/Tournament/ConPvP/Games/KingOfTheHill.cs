...
namespace Server.Engines.ConPVP
{
	...
	public sealed class KHBoardGump : Gump
	{
			...
			: base(60, 60)
		{
			...
			{
				var teamInfo = entries[i] as KHTeamInfo;
	...
	public sealed class KHTeamInfo : IRankedCTF, IComparable
	{
		...
		public KHPlayerInfo this[Mobile mob]
		{
			get
			{
				...
				var val = m_Players[mob] as KHPlayerInfo;
	...
	public sealed class KHGame : EventGame
	{
		...
		public override bool CantDoAnything(Mobile mob)
		{
			...
			{
				for (var i = 0; i < m_Controller.Hills.Length; i++)
				{
		...
		private void Finish_Callback()
		{
			...
			var winner = (KHTeamInfo)(teams.Count > 0 ? teams[0] : null);
			...
			for (var i = 0; i < teams.Count; ++i)
			{
				...
				var leader = ((KHTeamInfo)teams[i]).Leader;
