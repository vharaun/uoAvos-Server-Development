...
namespace Server.Items
{
	...
	public class DawnsMusicBox : Item, ISecurable
	{
		...
		{
			var box = newItem as DawnsMusicBox;
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			for (var i = 0; i < m_Tracks.Count; i++)
			{
				var info = GetInfo(m_Tracks[i]);
	...
	public class DawnsMusicGear : Item
	{
		...
		{
			var info = DawnsMusicBox.GetInfo(m_Music);
		...
		public class InternalTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				var box = targeted as DawnsMusicBox;
