	...
	public class NewPlayerTicket : Item
	{
		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				{
					var theirTicket = targeted as NewPlayerTicket;
					var them = theirTicket.m_Owner;
		...
		private class InternalGump : Gump
		{
			...
			public override void OnResponse(NetState sender, RelayInfo info)
			{
				...
				switch (info.ButtonID)
				{
					...
					case 3: item = new BookOfMagery(UInt64.MaxValue); number = 1010495; break; // A spellbook with all 1st to 4th circle spells has been placed in your backpack.
