...
{
	public class MistakenIdentity : ChainQuest
	{
	...
	public class YouScratchMyBack : ChainQuest
	{
	...
	public class FoolingAernya : ChainQuest
	{
	...
	public class NotQuiteThatEasy : ChainQuest
	{
		...
		public override void OnAccepted(ChainQuestInstance instance)
		{
			instance.PlayerContext.BedlamAccess = true; // Permanent access
		}
	}

	public class ConvinceMe : ChainQuest
	{
	...
	public class TuitionReimbursement : ChainQuest
	{
		public override bool IsChainTriggered => true;
