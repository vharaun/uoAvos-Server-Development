...
{
	/// Human To Elf ChainQuests
	public class Seasons : ChainQuest
	{
		...
		public Seasons()
		{
			...
			Objectives.Add(new CollectObjective(20, typeof(RawSaltwaterFishSteak), 1022426)); // raw fish steak
	...
	public class CaretakerOfTheLand : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	public class WisdomOfTheSphynx : ChainQuest
	{
		public override bool RecordCompletion => true;
		...
		private class InternalObjective : CollectObjective
		{
			...
			{
				var pitcher = item as Pitcher; // Only pitchers work
	...
	public class DefendingTheHerd : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	public class TheBalanceOfNature : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	public class TheJoysOfLife : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	/// Elf To Human ChainQuests
	public class Ingenuity : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	public class HeaveHo : ChainQuest
	{
		public override bool RecordCompletion => true;
	...
	public class HumanInNeed : ChainQuest
	{
		public override bool RecordCompletion => true;
		...
		{
			ChainQuestSystem.GetOrCreateContext(pm).SetDoneQuest(ChainQuestSystem.FindQuest(typeof(HumanInNeed)));
			pm.SendLocalizedMessage(1074949, "", 0x2A); // You have demonstrated your compassion!  Your kind actions have been noted.
		}
	}

	public class AllSeasonAdventurer : ChainQuest
	{
		public override bool RecordCompletion => true;
