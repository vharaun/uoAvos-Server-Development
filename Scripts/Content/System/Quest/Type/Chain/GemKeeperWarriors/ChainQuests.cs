...
{
	public class WarriorsOfTheGemkeeper : ChainQuest
	{
	...
	public class CloseEnough : ChainQuest
	{
	...
	public class TakingTheBullByTheHorns : ChainQuest
	{
	...
	public class EmissaryToTheMinotaur : ChainQuest
	{
		public override bool IsChainTriggered => true;
