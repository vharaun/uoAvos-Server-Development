...
namespace Server.Engines.Quests.Items
{
	public class EminosKatanaChest : WoodenChest
	{
		...
		public override void OnDoubleClick(Mobile from)
		{
			...
			if (player != null && player.InRange(GetWorldLocation(), 2))
			{
				...
				if (qs is EminosUndertakingQuest)
				{
					...
					{
						var obj = qs.FindObjective(typeof(HallwayWalkObjective_EminosUndertakingQuest));
		...
		public override bool CheckLift(Mobile from, Item item, ref LRReason reject)
		{
			...
			{
				var obj = player.Quest.FindObjective(typeof(HallwayWalkObjective_EminosUndertakingQuest)) as HallwayWalkObjective_EminosUndertakingQuest;
