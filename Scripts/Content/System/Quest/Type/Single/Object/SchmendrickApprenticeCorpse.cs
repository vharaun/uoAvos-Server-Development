...
namespace Server.Engines.Quests.Items
{
	public class SchmendrickApprenticeCorpse : Corpse
	{
		...
		{
			var hue = Notoriety.GetHue(Server.Misc.NotorietyHandlers.CorpseNotoriety(from, this));
		...
		public override void Open(Mobile from, bool checkSelfLoot)
		{
			...
			if (player != null)
			{
				...
				{
					var obj = qs.FindObjective(typeof(FindApprenticeObjective_UzeraanTurmoilQuest));
