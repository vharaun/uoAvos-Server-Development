...
namespace Server.Engines.Quests.Items
{
	public class ScrollOfAbraxus : QuestItem
	{
		...
		public override bool CanDrop(PlayerMobile player)
		{
			...
			//return !( qs.IsObjectiveInProgress( typeof( RetrieveAbraxusScrollObjective_DarkTidesQuest ) ) || qs.IsObjectiveInProgress( typeof( ReadAbraxusScrollObjective_DarkTidesQuest ) ) );
			return false;
		}
		...
		public override void OnAdded(IEntity parent)
		{
			...
			if (pm != null)
			{
				...
				{
					var obj = qs.FindObjective(typeof(RetrieveAbraxusScrollObjective_DarkTidesQuest));
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (IsChildOf(from.Backpack))
			{
				...
				if (pm != null)
				{
					...
					if (qs is DarkTidesQuest)
					{
						var obj = qs.FindObjective(typeof(ReadAbraxusScrollObjective_DarkTidesQuest));
