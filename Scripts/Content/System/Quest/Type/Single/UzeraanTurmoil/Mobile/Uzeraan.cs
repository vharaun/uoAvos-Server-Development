	...
	public class Uzeraan : BaseQuester
	{
		...
		public override void OnTalk(PlayerMobile player, bool contextMenu)
		{
			...
			if (qs is UzeraanTurmoilQuest)
			{
				...
				{
					qs.AddConversation(new LostScrollOfPowerConversation_UzeraanTurmoilQuest(true));
				}
				else if (UzeraanTurmoilQuest.HasLostFertileDirt(player))
				{
					qs.AddConversation(new LostFertileDirtConversation_UzeraanTurmoilQuest(true));
				}
				else if (UzeraanTurmoilQuest.HasLostDaemonBlood(player))
				{
					qs.AddConversation(new LostDaemonBloodConversation_UzeraanTurmoilQuest());
				}
				else if (UzeraanTurmoilQuest.HasLostDaemonBone(player))
				{
					qs.AddConversation(new LostDaemonBoneConversation_UzeraanTurmoilQuest());
				}
				else
				{
					if (player.Profession == 2) // magician
					{
						...
						{
							qs.AddConversation(new FewReagentsConversation_UzeraanTurmoilQuest());
						}
					}

					var obj = qs.FindObjective(typeof(FindUzeraanBeginObjective_UzeraanTurmoilQuest));
					...
					{
						obj = qs.FindObjective(typeof(FindUzeraanFirstTaskObjective_UzeraanTurmoilQuest));
						...
						{
							obj = qs.FindObjective(typeof(FindUzeraanAboutReportObjective_UzeraanTurmoilQuest));
							...
							{
								obj = qs.FindObjective(typeof(ReturnScrollOfPowerObjective_UzeraanTurmoilQuest));
								...
								{
									obj = qs.FindObjective(typeof(ReturnFertileDirtObjective_UzeraanTurmoilQuest));
									...
									{
										obj = qs.FindObjective(typeof(ReturnDaemonBloodObjective_UzeraanTurmoilQuest));
										...
										{
											obj = qs.FindObjective(typeof(ReturnDaemonBoneObjective_UzeraanTurmoilQuest));
		...
		public override bool OnDragDrop(Mobile from, Item dropped)
		{
			...
			if (player != null)
			{
				...
				if (qs is UzeraanTurmoilQuest)
				{
					...
					{
						var obj = qs.FindObjective(typeof(ReturnScrollOfPowerObjective_UzeraanTurmoilQuest));
					...
					{
						var obj = qs.FindObjective(typeof(ReturnFertileDirtObjective_UzeraanTurmoilQuest));
					...
					{
						var obj = qs.FindObjective(typeof(ReturnDaemonBloodObjective_UzeraanTurmoilQuest));
					...
					{
						var obj = qs.FindObjective(typeof(ReturnDaemonBoneObjective_UzeraanTurmoilQuest));
