...
namespace Server.Engines.Quests.Mobiles
{
	public class Dryad : BaseQuester
	{
		...
		public override bool CanTalkTo(PlayerMobile to)
		{
			...
			return (qs != null && qs.FindObjective(typeof(FindDryadObjective_UzeraanTurmoilQuest)) != null);
		}
		...
		public override void OnTalk(PlayerMobile player, bool contextMenu)
		{
			...
			if (qs is UzeraanTurmoilQuest)
			{
				...
				{
					FocusTo(player);
					qs.AddConversation(new LostFertileDirtConversation_UzeraanTurmoilQuest(false));
				}
				else
				{
					var obj = qs.FindObjective(typeof(FindDryadObjective_UzeraanTurmoilQuest));
		...
		public override bool OnDragDrop(Mobile from, Item dropped)
		{
			...
			if (player != null)
			{
				...
				if (qs != null && dropped is Apple && UzeraanTurmoilQuest.HasLostFertileDirt(from))
				{
					...
					{
						dropped.Consume();
						qs.AddConversation(new DryadAppleConversation_UzeraanTurmoilQuest());
