...
namespace Server.Engines.Quests.Mobiles
{
	public class Schmendrick : BaseQuester
	{
		...
		public override bool CanTalkTo(PlayerMobile to)
		{
			...
			return (qs != null && qs.FindObjective(typeof(FindSchmendrickObjective_UzeraanTurmoilQuest)) != null);
		}
		...
		public override void OnTalk(PlayerMobile player, bool contextMenu)
		{
			...
			if (qs is UzeraanTurmoilQuest)
			{
				...
				{
					FocusTo(player);
					qs.AddConversation(new LostScrollOfPowerConversation_UzeraanTurmoilQuest(false));
				}
				else
				{
					var obj = qs.FindObjective(typeof(FindSchmendrickObjective_UzeraanTurmoilQuest));
