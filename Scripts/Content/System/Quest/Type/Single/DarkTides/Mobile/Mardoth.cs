...
namespace Server.Engines.Quests.Mobiles
{
	public class Mardoth : BaseQuester
	{
		...
		public override bool CanTalkTo(PlayerMobile to)
		{
			...
			return (qs.FindObjective(typeof(FindMardothAboutVaultObjective_DarkTidesQuest)) != null);
		}
		...
		public override void OnTalk(PlayerMobile player, bool contextMenu)
		{
			...
			if (qs is DarkTidesQuest)
			{
				...
				{
					qs.AddConversation(new LostCallingScrollConversation_DarkTidesQuest(true));
				}
				else
				{
					var obj = qs.FindObjective(typeof(FindMardothAboutVaultObjective_DarkTidesQuest));
					...
					{
						obj = qs.FindObjective(typeof(FindMardothAboutKronusObjective_DarkTidesQuest));
						...
						{
							obj = qs.FindObjective(typeof(FindMardothEndObjective_DarkTidesQuest));
