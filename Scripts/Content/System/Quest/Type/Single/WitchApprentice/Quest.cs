...
namespace Server.Engines.Quests.Definitions
{
	public class WitchApprenticeQuest : QuestSystem
	{
		private static readonly Type[] m_TypeReferenceTable = new Type[]
			{
				typeof( FindApprenticeObjective_WitchApprenticeQuest ),
				typeof( FindGrizeldaAboutMurderObjective_WitchApprenticeQuest ),
				typeof( KillImpsObjective_WitchApprenticeQuest ),
				typeof( FindZeefzorpulObjective_WitchApprenticeQuest ),
				typeof( ReturnRecipeObjective_WitchApprenticeQuest ),
				typeof( FindIngredientObjective_WitchApprenticeQuest ),
				typeof( ReturnIngredientsObjective_WitchApprenticeQuest ),
				typeof( DontOfferConversation_WitchApprenticeQuest ),
				typeof( AcceptConversation_WitchApprenticeQuest ),
				typeof( HagDuringCorpseSearchConversation_WitchApprenticeQuest ),
				typeof( ApprenticeCorpseConversation_WitchApprenticeQuest ),
				typeof( MurderConversation_WitchApprenticeQuest ),
				typeof( HagDuringImpSearchConversation_WitchApprenticeQuest ),
				typeof( ImpDeathConversation_WitchApprenticeQuest ),
				typeof( ZeefzorpulConversation_WitchApprenticeQuest ),
				typeof( RecipeConversation_WitchApprenticeQuest ),
				typeof( HagDuringIngredientsConversation_WitchApprenticeQuest ),
				typeof( BlackheartFirstConversation_WitchApprenticeQuest ),
				typeof( BlackheartNoPirateConversation_WitchApprenticeQuest ),
				typeof( BlackheartPirateConversation_WitchApprenticeQuest ),
				typeof( EndConversation_WitchApprenticeQuest ),
				typeof( RecentlyFinishedConversation_WitchApprenticeQuest )
			};
...
*/
		...
		public override void Accept()
		{
			...
			AddConversation(new AcceptConversation_WitchApprenticeQuest());
		}
	...
	public class DontOfferConversation_WitchApprenticeQuest : QuestConversation
	{
...
*/
		...
		public DontOfferConversation_WitchApprenticeQuest()
		{
		}
	}

	public class AcceptConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public AcceptConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new FindApprenticeObjective_WitchApprenticeQuest(true));
		}
	}

	public class HagDuringCorpseSearchConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public HagDuringCorpseSearchConversation_WitchApprenticeQuest()
		{
		}
	}

	public class ApprenticeCorpseConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public ApprenticeCorpseConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new FindGrizeldaAboutMurderObjective_WitchApprenticeQuest());
		}
	}

	public class MurderConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public MurderConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new KillImpsObjective_WitchApprenticeQuest(true));
		}
	}

	public class HagDuringImpSearchConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public HagDuringImpSearchConversation_WitchApprenticeQuest()
		{
		}
	}

	public class ImpDeathConversation_WitchApprenticeQuest : QuestConversation
	{
...
*/
		...
		public ImpDeathConversation_WitchApprenticeQuest(Point3D impLocation)
		{
			m_ImpLocation = impLocation;
		}

		public ImpDeathConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new FindZeefzorpulObjective_WitchApprenticeQuest(m_ImpLocation));
		}
	...
	public class ZeefzorpulConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public ZeefzorpulConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new ReturnRecipeObjective_WitchApprenticeQuest());
		}
	}

	public class RecipeConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public RecipeConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			System.AddObjective(new FindIngredientObjective_WitchApprenticeQuest(new Ingredient[0]));
		}
	}

	public class HagDuringIngredientsConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public HagDuringIngredientsConversation_WitchApprenticeQuest()
		{
		}
	}

	public class BlackheartFirstConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public BlackheartFirstConversation_WitchApprenticeQuest()
		{
		}

		public override void OnRead()
		{
			var obj = System.FindObjective(typeof(FindIngredientObjective_WitchApprenticeQuest)) as FindIngredientObjective_WitchApprenticeQuest;

			if (obj != null)
			{
				System.AddObjective(new FindIngredientObjective_WitchApprenticeQuest(obj.Ingredients, true));
			}
		}
	}

	public class BlackheartNoPirateConversation_WitchApprenticeQuest : QuestConversation
	{
		...
		public BlackheartNoPirateConversation_WitchApprenticeQuest(bool tricorne, bool drunken)
		{
			m_Tricorne = tricorne;
			m_Drunken = drunken;
		}

		public BlackheartNoPirateConversation_WitchApprenticeQuest()
		{
		}
	...
	public class BlackheartPirateConversation_WitchApprenticeQuest : QuestConversation
	{
		...
		public BlackheartPirateConversation_WitchApprenticeQuest(bool firstMet)
		{
			m_FirstMet = firstMet;
		}

		public BlackheartPirateConversation_WitchApprenticeQuest()
		{
		}
	...
	public class EndConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public EndConversation_WitchApprenticeQuest()
		{
		}
	...
	public class RecentlyFinishedConversation_WitchApprenticeQuest : QuestConversation
	{
		public override object Message =>
...
*/
		...
		public RecentlyFinishedConversation_WitchApprenticeQuest()
		{
		}
	...
	public class FindApprenticeObjective_WitchApprenticeQuest : QuestObjective
	{
...
*/
		...
		public FindApprenticeObjective_WitchApprenticeQuest(bool init)
		{
			if (init)
			{
		...
		public FindApprenticeObjective_WitchApprenticeQuest()
		{
		}
		...
		{
			System.AddConversation(new ApprenticeCorpseConversation_WitchApprenticeQuest());
		}
	...
	public class FindGrizeldaAboutMurderObjective_WitchApprenticeQuest : QuestObjective
	{
		public override object Message =>
...
*/
		...
		public FindGrizeldaAboutMurderObjective_WitchApprenticeQuest()
		{
		}

		public override void OnComplete()
		{
			System.AddConversation(new MurderConversation_WitchApprenticeQuest());
		}
	}

	public class KillImpsObjective_WitchApprenticeQuest : QuestObjective
	{
...
*/
		...
		public KillImpsObjective_WitchApprenticeQuest(bool init)
		{
			if (init)
			{
		...
		public KillImpsObjective_WitchApprenticeQuest()
		{
		}
		...
		public override void OnComplete()
		{
			...
			System.AddConversation(new ImpDeathConversation_WitchApprenticeQuest(loc));
		}
	...
	public class FindZeefzorpulObjective_WitchApprenticeQuest : QuestObjective
	{
		private Point3D m_ImpLocation;
...
*/
		...
		public FindZeefzorpulObjective_WitchApprenticeQuest(Point3D impLocation)
		{
			m_ImpLocation = impLocation;
		}

		public FindZeefzorpulObjective_WitchApprenticeQuest()
		{
		}
		...
		private void DeleteImp(object imp)
		{
			...
			System.AddConversation(new ZeefzorpulConversation_WitchApprenticeQuest());
		}
	...
	public class ReturnRecipeObjective_WitchApprenticeQuest : QuestObjective
	{
		public override object Message =>
...
*/
		...
		public ReturnRecipeObjective_WitchApprenticeQuest()
		{
		}

		public override void OnComplete()
		{
			System.AddConversation(new RecipeConversation_WitchApprenticeQuest());
		}
	}

	public class FindIngredientObjective_WitchApprenticeQuest : QuestObjective
	{
		...
		public FindIngredientObjective_WitchApprenticeQuest(Ingredient[] oldIngredients) : this(oldIngredients, false)
		{
		}

		public FindIngredientObjective_WitchApprenticeQuest(Ingredient[] oldIngredients, bool blackheartMet)
		{
			if (!blackheartMet)
			{
		...
		public FindIngredientObjective_WitchApprenticeQuest()
		{
		}
		...
		public void NextStep()
		{
			...
			if (Step < 3)
			{
				System.AddObjective(new FindIngredientObjective_WitchApprenticeQuest(m_Ingredients));
			}
			else
			{
				System.AddObjective(new ReturnIngredientsObjective_WitchApprenticeQuest());
			}
		}
	...
	public class ReturnIngredientsObjective_WitchApprenticeQuest : QuestObjective
	{
		public override object Message =>
...
*/
		...
		public ReturnIngredientsObjective_WitchApprenticeQuest()
		{
		}

		public override void OnComplete()
		{
			System.AddConversation(new EndConversation_WitchApprenticeQuest());
		}
	}
