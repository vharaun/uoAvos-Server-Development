...
namespace Server.Engines.Quests.Mobiles
{
	public class Impresario : BaseQuester
	{
		...
		public override bool CanTalkTo(PlayerMobile to)
		{
			...
			return qs.IsObjectiveInProgress(typeof(FindSheetMusicObjective_CollectorQuest));
		}
		...
		public override void OnTalk(PlayerMobile player, bool contextMenu)
		{
			...
			{
				var obj = qs.FindObjective(typeof(FindSheetMusicObjective_CollectorQuest)) as FindSheetMusicObjective_CollectorQuest;
				...
				if (obj != null && !obj.Completed)
				{
					...
					{
						qs.AddConversation(new NoSheetMusicConversation_CollectorQuest());
					}
				}
			}
		}
