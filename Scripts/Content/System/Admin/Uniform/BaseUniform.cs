...
{
	public abstract class BaseAdminUniform : Item
	{
		...
		public BaseAdminUniform(AccessLevel level, int hue, int itemID) : base(itemID)
		{
			Hue = hue;
			Weight = 1.0;
			Movable = false;
		...
		public BaseAdminUniform(Serial serial) : base(serial)
		{
		}
