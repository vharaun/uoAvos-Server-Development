...
{
	public abstract class BaseAdminCosplay : Item
	{
		...
		public BaseAdminCosplay(AccessLevel level, int hue, int itemID) : base(itemID)
		{
			Hue = hue;
			Weight = 1.0;
			Movable = false;
		...
		public BaseAdminCosplay(Serial serial) : base(serial)
		{
		}
