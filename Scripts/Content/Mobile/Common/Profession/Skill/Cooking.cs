...
namespace Server.Engines.Craft
{
	public class DefCooking : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			if (Core.SE)
			{
				index = AddCraft(typeof(GreenTeaPot), 1044496, 1030315, 80.0, 130.0, typeof(GreenTeaLeafBasket), 1030316, 1, 1044253);
				AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
				...
				AddRes(index, typeof(RawSaltwaterFishSteak), 1044476, 10, 1044253);
				SetNeededExpansion(index, Expansion.SE);
			...
			if (Core.SE)
			{
				index = AddCraft(typeof(MisoSoup), 1044497, 1030317, 60.0, 110.0, typeof(RawSaltwaterFishSteak), 1044476, 1, 1044253);
				AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
				SetNeededExpansion(index, Expansion.SE);
				SetNeedOven(index, true);

				index = AddCraft(typeof(WhiteMisoSoup), 1044497, 1030318, 60.0, 110.0, typeof(RawSaltwaterFishSteak), 1044476, 1, 1044253);
				AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
				SetNeededExpansion(index, Expansion.SE);
				SetNeedOven(index, true);

				index = AddCraft(typeof(RedMisoSoup), 1044497, 1030319, 60.0, 110.0, typeof(RawSaltwaterFishSteak), 1044476, 1, 1044253);
				AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
				SetNeededExpansion(index, Expansion.SE);
				SetNeedOven(index, true);

				index = AddCraft(typeof(AwaseMisoSoup), 1044497, 1030320, 60.0, 110.0, typeof(RawSaltwaterFishSteak), 1044476, 1, 1044253);
				AddRes(index, typeof(BaseBeverage), 1046458, 1, 1044253);
				SetNeededExpansion(index, Expansion.SE);
				SetNeedOven(index, true);
			}
			...
			index = AddCraft(typeof(SaltwaterFishSteak), 1044498, 1022427, 0.0, 100.0, typeof(RawSaltwaterFishSteak), 1044476, 1, 1044253);
			SetNeedHeat(index, true);
			SetUseAllRes(index, true);
