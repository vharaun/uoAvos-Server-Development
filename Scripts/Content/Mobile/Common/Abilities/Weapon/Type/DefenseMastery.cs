...
namespace Server.Items
{
	public class DefenseMastery : WeaponAbility
	{
		...
		public override void OnHit(Mobile attacker, Mobile defender, int damage)
		{
			...
			var modifier = (int)(30.0 * ((Math.Max(attacker.Skills[SkillName.Bushido].Value, attacker.Skills[SkillName.Ninjitsu].Value) - 50.0) / 70.0));

			var info = m_Table[attacker] as DefenseMasteryInfo;
		...
		{
			var info = m_Table[targ] as DefenseMasteryInfo;
		...
		{
			var info = (DefenseMasteryInfo)state;
